...
import com.linkedout.common.util.converter.RoleToStringConverter;
import com.linkedout.common.util.converter.StringToRoleConverter;
...
public class AutoConfiguration {
  ...
  /**
   * API 특정 메시징 응답을 처리하기 위한 ApiMessageResponseHandler의 인스턴스를 제공합니다. 이 핸들러는 Redis와 통합되며 JSON 처리를 위해
   * 제공된 ObjectMapper를 사용합니다.
   *
  ...
  /**
   * RabbitMQ와 ObjectMapper를 사용한 JSON 직렬화/역직렬화를 통해 서비스 간 통신을 담당하는 ServiceMessageClient용 빈을 제공합니다. 이
