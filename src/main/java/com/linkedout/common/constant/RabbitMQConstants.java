...
public class RabbitMQConstants {
  ...
  //	Recipe
  public static final String RECIPE_API_QUEUE = "recipe.api.queue";
  public static final String RECIPE_SERVICE_CONSUMER_QUEUE = "recipe.service.consumer";
  public static final String RECIPE_SERVICE_LISTENER_QUEUE = "recipe.service.listener";

  public static final String RECIPE_API_ROUTING_KEY = "recipe.api.routing.key";
