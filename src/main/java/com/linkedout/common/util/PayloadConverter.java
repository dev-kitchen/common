 ...
 * <p>
 * 이 클래스는 Jackson ObjectMapper를 사용하여 객체를 타입 안전하게 변환합니다.
 * 페이로드가 이미 대상 타입인 경우 직접 캐스팅하고, 그렇지 않은 경우 ObjectMapper로 변환합니다.
 * <p>
 * 이 클래스는 Spring이 관리하는 컴포넌트이며 필요한 곳에 자동으로 주입됩니다.
 */
@Component
